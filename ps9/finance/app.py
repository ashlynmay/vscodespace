        ...
        if not request.form.get("symbol") or not request.form.get("shares"):
            ...
            if cash - total > 0:
                ...
                if existing_total:
                    ...
                    db.execute("INSERT INTO history (id, stock, shares, price, total, type, dt) VALUES (?, ?, ?, ?, ?, 'BUY', ?)", session["user_id"], stock, shares, float(price), float(total), current_datetime)
                    ...
                    db.execute("INSERT INTO history (id, stock, shares, price, total, type, dt) VALUES (?, ?, ?, ?, ?, 'BUY', ?)", session["user_id"], stock, shares, price, total, current_datetime)
