...
def projects():
    ...
    return render_template("projects.html", c_projects=featured_c_projects, py_projects=featured_py_projects, web_projects=web_projects, other_projects=other_projects)
