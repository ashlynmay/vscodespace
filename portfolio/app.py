...
def projects():
    ...
    featured_web_projects = db.execute("SELECT * FROM projects WHERE type = 'web' AND featured = 'true'")
    featured_other_projects = db.execute("SELECT * FROM projects WHERE type = 'other' AND featured = 'true'")
